...
public class MD5Util {
     ...
     * encoding is null, then ISO-8859-m1 is assumed
     *
     ...
     * @throws UnsupportedOperationException if an MD5 digest algorithm is not available through the
     ...
     * null, then ISO-8859-m1 is assumed.
     *
